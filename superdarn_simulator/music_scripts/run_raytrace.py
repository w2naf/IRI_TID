...
if __name__ == '__main__':
    iono_dict = dict(
            ...
            lat_0 =   32., lat_1 =   80., lat_step=1.50,
            lon_0 = -100., lon_1 =  -40., lon_step=1.50)
#    iono_dict = dict(
#            hgt_0 =   60., hgt_1 =  560., hgt_step=1.0,
...
#            lon_0 = -100., lon_1 =  -40., lon_step=0.10)
    ...
    dct = dict(
        ...
        ngates                                  = 100,
        freq                                    = 10.5,
        sTime                                   = datetime.datetime(2012,12,21,0),
        eTime                                   = datetime.datetime(2012,12,21,0,4),
...
#    waves.append({'lambda_h':198,'azm':152.+180.,'T_minutes':40})
    ...
    for run_config in run_configs:
        ...
        for wave in waves:
            ...
            azm         = this_wave.get('azm')
            lambda_h    = this_wave.get('lambda_h')

            wave_list = []
            src_lat, src_lon, azm   = get_source_loc(rng,azm,radar,sTime,lat_ctr=lat_ctr,lon_ctr=lon_ctr,azm_plus_boresite=False)
